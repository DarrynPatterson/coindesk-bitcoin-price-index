    ...
    if (this.state.currency === "USD") {
      list = (
        <li className="list-group-item">
          ...
          <strong>
            {parseFloat(this.props.bpi.USD.rate.replace(",", "")).toFixed(0)}
          </strong>
        </li>
      );
      ...
      list = (
        <li className="list-group-item">
          ...
          <strong>
            {parseFloat(this.props.bpi.GBP.rate.replace(",", "")).toFixed(0)}
          </strong>
        </li>
      );
      ...
      list = (
        <li className="list-group-item">
          ...
          <strong>
            {parseFloat(this.props.bpi.EUR.rate.replace(",", "")).toFixed(0)}
          </strong>
        </li>
      );
    }
